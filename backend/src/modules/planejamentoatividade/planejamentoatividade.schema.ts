...
// Campos alinhados às colunas reais de public."PlanejamentoAtividade"
// (prisma/schema.prisma).
export const createPlanejamentoAtividadeSchema = z.object({
  descritivo: z.string().optional(),
  base_descritivo: z.string().optional(),
  ...
  travado: z.string().optional(),
  is_routine: z.string().optional()
});

export const updatePlanejamentoAtividadeSchema = createPlanejamentoAtividadeSchema.partial();

export const planejamentoAtividadeParamsSchema = z.object({
  id: z.string().min(1)
});

export type CreatePlanejamentoAtividadeInput = z.infer<typeof createPlanejamentoAtividadeSchema>;
export type UpdatePlanejamentoAtividadeInput = z.infer<typeof updatePlanejamentoAtividadeSchema>;
